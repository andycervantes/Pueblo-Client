...
// $Header: /home/cvs/chaco/modules/client/msw/ChWorld/ChWList.cpp,v 2.11 1996/03/18 21:06:11 coyote Exp $
...
void ChWorldList::Add( const string& strName, const string& strDesc,
...
void ChWorldList::Remove( const string& strName, const string& strUsername )
{
	ChPosition		pos;
...
ChWorldInfo* ChWorldList::FindName( const string& strName,
...
ChPosition ChWorldList::FindNamePos(  const string& strName,
										const string& strUsername )
{
	ChPosition		pos;
