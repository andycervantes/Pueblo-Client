...
// $Header: /home/cvs/chaco/modules/client/msw/ChWorld/ChHist.cpp,v 2.1 1996/02/20 18:32:38 coyote Exp $
...
void ChHistory::Add( const string& strLine )
{
...
bool ChHistory::GetNext( string& strLine )
{
...
bool ChHistory::GetPrevious( string& strLine )
{
	bool	boolSuccess = true;
...
bool ChHistory::GetExpansion( string& strText, ChPosition& startPos )
{
	...
	{
		string		strHistText = m_historyList.Get( startPos );
