...
// $Header: /home/cvs/chaco/modules/client/msw/ChWorld/TinTinVars.cpp,v 2.9 1996/09/12 19:10:24 pritham Exp $
...
inline bool IsNumeric( const string& strVal )
{
	if (strVal.IsEmpty())
...
CH_INTERN_FUNC( void )
AppendQuotedArg( string& strDest, const string& strAppend )
{
	string		strTemp;
...
void TinTin::DoChangeCase( const string& strArgs, bool boolToUpper )
{
...
void TinTin::DoVariable( const string& strArgs )
{
	const char*	pstrArgs = strArgs;
	string		strLeft;
	string		strRight;
...
void TinTin::DoUnvariable( const string& strArgs )
{
...
bool TinTin::IsVarNameValid( const string& strName )
{
