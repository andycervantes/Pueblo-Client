...
// $Header: /home/cvs/chaco/modules/client/msw/ChWorld/ChWorldStream.h,v 2.6 1996/03/27 02:16:24 pritham Exp $
...
class ChWorldFileHTTPReq   : public ChWorldHTTPReq
{
	...
	public:
		ChWorldFileHTTPReq( int iReqID, HWND hWnd, const string& strHTML ) :
				ChWorldHTTPReq( iReqID ),
				m_hWndNotify( hWnd ),
				m_strHTML( strHTML )
					{
		...
		inline const string& GetFileName() { return m_strFile; }
		inline const string& GetMimeType() { return m_strData; }
		inline const string& GetErrorMsg() { return m_strData; }  

		inline void SetLoadComplete(  const string& strURL, const string& strFile,
		...
		inline void SetLoadError(  const string& strURL, const string& strErrMsg )
						{
							m_strURL = strURL;
							m_strData = strErrMsg;
						}
