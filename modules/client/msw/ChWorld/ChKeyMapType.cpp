...
// $Header: /home/cvs/chaco/modules/client/msw/ChWorld/ChKeyMapType.cpp,v 2.3 1996/05/02 21:07:08 coyote Exp $
...
ChKeyMapType::ChKeyMapType( const string& strType )
{
	Set( strType );
}
...
string ChKeyMapType::GetName() const
{
...
void ChKeyMapType::Set( const string& strType )
{
