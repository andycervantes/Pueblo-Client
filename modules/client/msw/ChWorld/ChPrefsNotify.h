...
// $Header: /home/cvs/chaco/modules/client/msw/ChWorld/ChPrefsNotify.h,v 2.3 1996/09/12 19:09:59 pritham Exp $
...
class ChNotifyPrefsPage : public ChPropertyBaseClass
{
	...
	public:
		...
		inline bool GetNotifyAlert() { return m_boolAlert; }
		inline const string& GetNotifyMatch() { return m_strMatch; }

		void Set( bool boolNotify, bool boolAlert, const string& strMatch );
