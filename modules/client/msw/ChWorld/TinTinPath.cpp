...
// $Header: /home/cvs/chaco/modules/client/msw/ChWorld/TinTinPath.cpp,v 2.7 1996/09/12 19:10:20 pritham Exp $
...
void TinTin::CheckInsertPath( const string& strCommand )
{
...
void TinTin::DoMap( const string& strArgs )
{
	string		strDirection;
...
void TinTin::DoPathdir( const string& strArgs )
{
...
void TinTin::DoSavepath( const string& strArgs )
{
	string			strName;
	TinTinListNode*	pNode = GetListPath()->GetTop();
