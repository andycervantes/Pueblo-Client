...
// $Header: /home/cvs/chaco/modules/client/msw/ChWorld/ChConnectDlg.h,v 2.3 1996/09/12 19:09:58 pritham Exp $
...
class ChConnectingDlg : public ChDialog
{
	public:
		...
		bool Create( const string& strMessage, CWnd* pParentWnd = 0 );
		void ShowAfterASec();
		void ChangeMessage( const string& strMessage );
