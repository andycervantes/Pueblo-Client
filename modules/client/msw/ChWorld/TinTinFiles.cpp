...
// $Header: /home/cvs/chaco/modules/client/msw/ChWorld/TinTinFiles.cpp,v 2.9 1996/09/12 19:10:15 pritham Exp $
...
void TinTin::DoWrite( const string& strFilename )
{
	string		strFilePath;
	ofstream	file;
...
void TinTin::CompleteFilePath( string& strFilePath )
{
	int		iLastPart;
	string	strLastPart;
...
void TinTin::FormatCommand( const string& strCommand, const string& strLeft,
