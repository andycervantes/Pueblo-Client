...
// $Header: /home/cvs/chaco/modules/client/msw/ChAd/Dll.cpp,v 1.1 1995/10/13 04:25:02 coyote Exp $
...
CH_GLOBAL_VAR AFX_EXTENSION_MODULE ChAdDLL = { NULL, NULL };
...
DllMain( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
	...
	{
		TRACE0( "CHAD.DLL Initializing!\n" );

											/* Extension DLL one-time
												initialization */

		AfxInitExtensionModule( ChAdDLL, hInstance );

											/* Insert this DLL into the
												resource chain */
		new CDynLinkLibrary( ChAdDLL );
	}
	else if (DLL_PROCESS_DETACH == dwReason)
	{
		TRACE0( "CHAD.DLL Terminating!\n" );
	}
