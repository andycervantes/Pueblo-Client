...
// $Header: /home/cvs/chaco/modules/client/msw/ChText/TinTinInfo.h,v 2.1 1996/02/16 22:36:32 coyote Exp $
...
class TinTinInfo : public ChDialog
{
	public:
		...
		void SetFlags( bool boolIgnoreActions, bool boolStartQuotes,
		...
		CString	m_strStartQuotes;
		CString	m_strPresubs;
		CString	m_strDoSubs;
		CString	m_strDoActions;
		//}}AFX_DATA
	...
	protected:
		...
		void SetYesNo( string& strField, bool boolYes );
		void SetOnOff( string& strField, bool boolOn );
		void SetTrueFalse( string& strField, bool boolTrue );
