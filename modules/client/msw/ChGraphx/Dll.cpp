...
// $Header: /home/cvs/chaco/modules/client/msw/ChGraphx/Dll.cpp,v 2.3 1995/08/31 18:49:17 jimd Exp $
...
CH_GLOBAL_VAR AFX_EXTENSION_MODULE ChGraphicsDLL = { NULL, NULL };
...
DllMain( HINSTANCE hInstance, DWORD dwReason, LPVOID lpReserved )
{
	...
	{
		TRACE0( "CHGRAPHX.DLL Initializing!\n" );

											/* Extension DLL one-time
												initialization */

		AfxInitExtensionModule( ChGraphicsDLL, hInstance );

											/* Insert this DLL into the
												resource chain */
		new CDynLinkLibrary( ChGraphicsDLL );
	}
	else if (DLL_PROCESS_DETACH == dwReason)
	{
		TRACE0( "CHGRAPHX.DLL Terminating!\n" );
	}
