...
// $Header: /home/cvs/chaco/modules/client/msw/ChSound/ChSoundStream.h,v 1.4 1996/07/04 22:50:24 coyote Exp $

#if !defined( _CHSNDSTRM_H )
#define _CHSNDSTRM_H
...
/*----------------------------------------------------------------------------
	ChSoundStreamManager class
----------------------------------------------------------------------------*/

class ChSoundStreamManager  :  public ChHTTPStreamManager
{
	public :
		ChSoundStreamManager( ChSoundMainInfo* pCore );
		virtual ~ChSoundStreamManager() {}
