...
// $Header: /home/cvs/chaco/modules/client/portable/ChGraphx/ChTrMisc.cpp,v 1.2 1996/09/14 22:28:42 pritham Exp $
#if ( _MSC_VER > 900	 )
...
int ChTriangulator::generate_random_ordering(int n)
{
#if 0
  struct timeval tval;
...
/* segments in S */
int ChTriangulator::choose_segment()
{
/*  
#ifdef DEBUG
...
int ChTriangulator::inserted(int segnum, int whichpt)
{
  int n1, n2;
...
int ChTriangulator::read_segments(FILE *infile)
{
  int nseg;
  register int i;
...
int ChTriangulator::math_logstar_n(int n)
{
  register int i;
  double v;
...
int ChTriangulator::math_N(int n, int h)
{
  register int i;
  double v;
