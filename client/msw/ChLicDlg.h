...
// $Header: /home/cvs/chaco/client/msw/ChLicDlg.h,v 2.2 1995/10/28 22:11:40 coyote Exp $
...
class ChLicenseDlg : public CDialog
{
	public:
		...
		int DoModal( const string& strLicenseFileName );
