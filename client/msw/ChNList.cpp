...
// $Header: /home/cvs/chaco/client/msw/ChNList.cpp,v 2.2 1995/07/18 04:30:57 coyote Exp $
...
ChNameList::ChNameList( const string& strGroup, const string& strLabel,
						char cDelim ) :
...
void ChNameList::Add( const string& strName )
{
	if (0 == GetCount())
	{										// First name
		m_strList = strName;
...
bool ChNameList::GetName( chint16& sStartIndex, string& strName )
{
...
bool ChNameList::IsInList( const string& strName )
{
