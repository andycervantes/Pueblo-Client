...
// $Header: /home/cvs/chaco/client/msw/ChRunTimeInfo.h,v 2.2 1996/03/15 20:07:11 coyote Exp $
...
class ChModuleRunInfo
{
	public:
		...
		ChModuleRunInfo( const string& strModule,  HINSTANCE hLibrary );

		#else	// defined( CH_MSW )

		ChModuleRunInfo( const string& strModule );
