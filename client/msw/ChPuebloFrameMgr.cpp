...
// $Header: /home/cvs/chaco/client/msw/ChPuebloFrameMgr.cpp,v 2.9 1996/09/17 21:42:10 pritham Exp $
...
{
	string		strLabel = ((ChMainFrame* const)pFrame)->GetLabel();
...
void ChApp::CreateNewFrame( const string& strArgs, const string& strLabel )
{
	#if ( _MFC_VER > 0x0400	 )
