...
// $Header: /home/cvs/chaco/client/msw/ChAccDlg.h,v 2.15 1996/06/17 23:19:54 coyote Exp $
...
class ChAccountDlgName : public ChWizardPage
{
	...
	public:
		...
		void GetWizardPageData( string& strData );

		inline const string& GetFirstName() const { return m_strFirstName; }
		inline const string& GetSurname() const { return m_strSurname; }
		#if 0
		inline const string& GetMiddleName() const { return m_strMiddleInitial; }
		#endif
...
class ChAccountDlgConn : public ChWizardPage
{
	...
	protected:
		...
		typedef enum { direct, school, aol, compuserve, prodigy,
						other } ConnType;
		typedef enum { modem9600, modem144, modem288, isdn, fractT1,
						t1 } ConnSpeed;
...
class ChAccountDlg : public ChWizard
{
	...
	public:
		...
		void GetWizardData( string& strData );
