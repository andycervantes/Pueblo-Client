...
int ChUnzip::matche(register const char *p, register const char *t)
//register char *p;
//register char *t;
{
...
*
----------------------------------------------------------------------------*/
int ChUnzip::matche_after_star (register const char *p, register const char *t)
//register char *p;
//register char *t;
{
...
int ChUnzip::match( const char * string, const char *pattern)
//char *string;
//char *pattern;
{
    int error_type;
