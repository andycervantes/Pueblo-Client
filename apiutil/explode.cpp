...
/* routines here  made member functions of ChUnzip*/
#if 0
...
int ChUnzip::get_tree( unsigned *l, unsigned n )
...
int ChUnzip::explode_lit8 ( struct huft *tb, struct huft *tl, 
...
int ChUnzip::explode_lit4( struct huft *tb, struct huft * tl, struct huft *td,
...
int ChUnzip::explode_nolit8( struct huft *tl, struct huft * td, int bl, int bd )
...
int ChUnzip::explode_nolit4(struct huft * tl, struct huft * td, int bl, int bd)
//struct huft *tl, *td;   /* length and distance decoder tables */
//int bl, bd;             /* number of bits decoded by tl[] and td[] */
   ...
   bits are read in, uncoded, for the low distance bits. */
{
  ...
  unsigned* l; /* bit lengths for codes */
