...
// $Header: /home/cvs/chaco/api/ChScrWnd.cpp,v 2.13 1996/04/20 22:14:11 coyote Exp $
...
void ChScrollWnd::UpdateBars()
{
	...
	{										/* If parent window responds to
		...
		boolParentCalc =
			(bool)pParentWnd->SendMessage( WM_RECALCPARENT, 0,
											(LPARAM)(LPCRECT)&rectClient );
