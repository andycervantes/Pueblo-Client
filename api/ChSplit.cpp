...
// $Header: /home/cvs/chaco/api/ChSplit.cpp,v 2.39 1996/09/26 02:02:47 pritham Exp $
...
ChSplitterBanner* ChSplitter::FindBanner( const string& strName )
{
	ChPosition			pos;
...
bool ChSplitter::Create( ChWnd* pParentWnd )
{
	...
	#if defined( CH_MSW )
	{
		...
		boolSuccess = CWnd::Create( m_strClass, "ChSplitter window",
...
string		ChSplitterBanner::m_strClass;
...
ChSplitterBanner::ChSplitterBanner( ChSplitter* pSplitter, ChPane* pPane,
									const string& strName, bool boolTop,
									chint16 sClientWidth,
									chint16 sClientHeight ) :
