...
ChPlugInInstance::ChPlugInInstance( const string& strURL, const string& strMimeType, uint16 mode )
			: m_strURL( strURL), 
...
bool ChPlugInInstance::New( ChHtmlView* pHtmlInst, const string& strLocalFile, ChSize& sizeWindow,
...
ChPlugInStream::ChPlugInStream( NPP pInst, const string& strURL, const string& strMimeType ) 
...
ChPlugInStream::ChPlugInStream( NPP pInst, const string& strURL, const string& strMimeType, void* pData ) 
									: m_pPlgInInst( pInst ), m_uMode( 1 ), 
									m_strURL( strURL ), m_strMimeType( strMimeType ),
									m_iState( newStream ),
									m_iError( NPERR_NO_ERROR ),
...
void ChPlugInStream::OnLoadComplete( const string& strFile, const string& strURL, 
...
void ChPlugInStream::OnLoadError( chint32 lError, const string& strURL )
{	
