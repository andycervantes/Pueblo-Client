...
// $Header: /home/cvs/chaco/api/ChAcct.cpp,v 2.3 1995/11/04 00:51:57 coyote Exp $
...
void ChAccountInfo::SetName( const string& strFirstName,
								const string& strMiddleName,
...
void ChAccountInfo::SetAddress( const string& strStreet,
								const string& strApt, const string& strCity,
								const string& strState, const string& strZip,
...
void ChAccountInfo::AddMiscField( const string& strLabel,
