...
bool ChArgumentList::GetArg( int iIndex, string& strName, string& strValue ) const
{
...
bool ChArgumentList::FindArg( const char* pstrName, string& strValue )
{
	int iIndex = 0;
	...
	while( pos )
	{
		string strName = m_argName.GetNext( pos );	
...
void ChArgumentList::AddArg( const string& strName, 	const string&  strValue )
{
	m_argName.AddTail( strName );	
	m_argValue.AddTail( strValue );	
}
