...
// $Header: /home/cvs/chaco/api/ChHTTP.cpp,v 2.43 1996/07/18 20:21:29 pritham Exp $
...
string 			ChHTTPSocketConn::m_strHTTPProxy;
chuint32		ChHTTPSocketConn::m_luHTTPProxyPort = 0;
string 			ChHTTPSocketConn::m_strFTPProxy;
...
void ChHTTPSocketConn::UpdateHTTPPreferences( const string& strProduct )
{
...
bool ChHTTPSocketConn::GetURL( const string& strURL, chparam userData,
...
bool ChHTTPSocketConn::PostURL( const string& strURL, const char* pstrBody,
...
bool ChHTTPSocketConn::IsURLCached( const string& strURL, const char* pstrDefURL /* = 0  */ )
{
	bool 			boolReturn = true;
	ChHTTPInfo*		pHTTPInfo;
...
bool ChHTTPSocketConn::IsVisitedURL( const string& strURL, const char* pstrDefURL /* = 0  */ )
{
	bool 			boolReturn = true;
	ChHTTPInfo*		pHTTPInfo;
...
bool ChHTTPSocketConn::GetCachedURL( const string& strURL, string& strName,
										string& strMimeType,
										const char* pstrDefURL /* = 0 */, 
...
bool ChHTTPSocketConn::DeleteCachedURL( const string& strURL, const char* pstrDefURL /* = 0 */ )
{
   	bool		 	boolReturn = true;
	ChHTTPInfo*		pHTTPInfo;
...
----------------------------------------------------------------------------*/
void ChHTTPSocketConn::GetProgressMsg( string& strProgressMessage, int& iPercentComplete )
{
	int 		iTotWait;
	int 		iTotalActive;
...
bool ChHTTPSocketConn::CreateAndValidateCacheDir( string& strDir )
{
