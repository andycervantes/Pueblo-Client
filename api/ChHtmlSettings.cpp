...
void ChHtmlSettings::SetProductName( const string& strProduct )
{
...
void ChHtmlSettings::ReadPreferences(  )
{
	...
	if ( m_iPixelHeight == 0 )
	{
		...
		m_iPixelHeight = -1 * ::GetDeviceCaps(hDC, LOGPIXELSY);
	...
	{
		m_luTextColor = ::GetSysColor( COLOR_BTNTEXT );
	}
	...
	{
		m_luBackColor = ::GetSysColor( COLOR_WINDOW );
	}
