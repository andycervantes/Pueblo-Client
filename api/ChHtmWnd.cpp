...
// $Header: /home/cvs/chaco/api/ChHtmWnd.cpp,v 2.99 1996/10/09 19:20:38 pritham Exp $
...
CH_INTERN_VAR string m_strHtmlClass;
...
CH_INTERN_FUNC( void )
EscapeAmpersands( string& strText );

CH_INTERN_FUNC( void )
EscapeBrackets( string& strText );
...
void ChHtmlWnd::InitHtmlWnd()
{
	...
	pView->SetEmbedMode( ChHtmlView::embedInternal );
 	...
 	ChHtmlViewObj * pFrameObj = new ChHtmlViewObj( 	string( TOP_WINDOW ), pView, (CFrameWnd*)0 );
	ASSERT( pFrameObj );
						...
						chuint32 flOptions , const string& strURL, ChHtmlView* pView )
{
	...
	string strDocMime( pstrMimeType ? pstrMimeType : "" );
	int iMimeType;
...
void ChHtmlWnd::EscapeForHTML( string& strTextOut )
{
	int	 	iIndex = 0;
...
void ChHtmlWnd::RemoveEntities( const char* pstrBuffer, string& strResult )
{
...
void ChHtmlWnd::OnViewSubmitForm( ChHtmlView* pView, const string& strAction, 
...
void ChHtmlWnd::OnHotSpot( chparam userData, const string& strDocURL  )
{
}
...
bool ChHtmlWnd::OnRedirect(  const string& strURL, bool boolWebTracker  )
{
	return false;
}
...
bool ChHtmlWnd::OnInline( const char* pstrArgs, const string& strDocURL  )
{
	return false;
}
...
void ChHtmlWnd::OnSubmitForm( const string& strCommand, const string& strMD5,
...
void ChHtmlWnd::OnLoadComplete( const string& strFile, const string& strURL,
...
void ChHtmlWnd::OnLoadError( chint32 lError, const string& strErrMsg, const string& strURL,
								chparam userData )
{	
}
...
----------------------------------------------------------------------------*/
void ChHtmlWnd::OnTrace( const string& strMsg, int iType )
{
...
#endif
{
	...
	string		strOldFixed =  m_pSettings->GetFixedFontName();
	string		strOldProportional = m_pSettings->GetProportionalFontName();
