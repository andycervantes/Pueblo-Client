...
// $Header: /home/cvs/chaco/api/ChWType.cpp,v 2.12 1996/05/06 19:31:55 coyote Exp $
...
ChWorldType::ChWorldType( const string& strType )
{
	Set( strType );
}
...
string ChWorldType::GetName() const
{
	WorldTypeName*	pTable = ChWorldType::m_typeNames;
	string			strType;
...
void ChWorldType::Set( const string& strType )
{
