...
bool ChURLParts::GetURLParts( const string& strURL, const char* pstrDefURL )
{
    char*	after_access;
    char*	p;
...
void ChURLParts::EscapeSpecialChars( string& strData )
{
	string strTmp;
	int i = 0;
...
const string& ChURLParts::GetURL()			
{ 
...
bool ChURLParts::MapHostFileToURL( const char* pstrLocal, string& strURL )
{

   	string strPath( pstrLocal );
...
bool ChURLParts::MapURLToHostFile( const char* pstrURL, string& strHostFile )
{
