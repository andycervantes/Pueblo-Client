...
// $Header: /home/cvs/chaco/api/ChWizard.cpp,v 2.15 1996/09/12 18:33:11 pritham Exp $
...
CH_INTERN_FUNC( void )
LoadBtnText( int iID, string& strText );
...
void ChWizardPage::UpdateNameValue( string& strBuffer, 
...
bool ChWizard::SetActivePage( int iPage )
{
	if (OnPageChanging())
	{
		...
		if (m_iCurPage >= 0)
		{
			string		strPageCaption;
			string		strWizCaption( m_strCaption );
