...
// $Header: /home/cvs/chaco/api/ChTime.cpp,v 2.4 1996/03/22 10:34:09 pritham Exp $
...
int ChTime::GetMonth( const string& strMonth )
{
	for( int i = 0; i < 12; i++ )
	{
...
#if !defined( CH_ARCH_16 )
string ChTime::Format( const char *pstrFormat )
{
...
#if !defined( CH_ARCH_16 )
string ChTimeSpan::Format( const char *pstrFormat)
{
