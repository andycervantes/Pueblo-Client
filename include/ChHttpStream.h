...
class CH_EXPORT_CLASS ChHTTPStream 
{
	public :
	    ...
	    virtual const string& GetURL() = 0;
	    virtual const string& GetMimeType() = 0;
	    virtual const string& GetCacheFilename() = 0;
		virtual const char* GetErrorMsg() = 0;
	    virtual const string& GetContentEncoding() = 0;
	    virtual const string& GetLastModified() = 0;
	    virtual const string& GetTargetWindowName() = 0;
