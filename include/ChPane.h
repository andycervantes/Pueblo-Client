...
// $Header: /home/cvs/chaco/include/ChPane.h,v 2.35 1996/05/28 21:16:19 pritham Exp $
...
class CH_EXPORT_CLASS ChPane
{
	...
	friend static void ChDestructHelper( ChPane* pItem );
	...
	public:
		...
		inline const string& GetTitle() const { return m_strTitle; }
		...
		ChPane* SetTitle( const string& strTitle );
	...
	protected:
		ChPane( const string& strName, ChPaneMgr* pPaneMgr,
				chint16 sIdealWidth, chint16 sIdealHeight, chparam userData,
				chflag32 flOptions );
		ChPane( PaneType type, const string& strName, ChPaneMgr* pPaneMgr );
		~ChPane();
...
class CH_EXPORT_CLASS ChPaneMgr
{
	...
	public:
		static const string strTextName;
		static const string strGraphicName;
	...
	public:
		...
		ChPane* FindPane( const string& strName );
		ChPane* CreatePane( const string& strName, chparam userData,
							chint16 sIdealWidth, chint16 sIdealHeight,
							chflag32 flOptions );
		void DestroyPane( const string& strName );
	...
	protected:
		string FindClassName( bool boolCloseable, chuint16 suIconID );
		string RegisterPaneClass( bool boolCloseable, chuint16 suIconID );
