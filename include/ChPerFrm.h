...
// $Header: /home/cvs/chaco/include/ChPerFrm.h,v 2.8 1996/09/12 18:16:53 pritham Exp $
...
#endif
{
	...
	public:
		...
		inline const string& GetLabel() const { return m_strLabel; }
	...
	#if !defined( CH_PUEBLO_PLUGIN )
		inline const string& GetRegSection() const { return m_strRegSection; }
	#endif
	...
	private:
		...
		static const string	strProfileRect;
		static const string	strProfileIcon;
		static const string	strProfileMax;
		static const string	strProfileTool;
		static const string	strProfileStatus;

 		string				m_strRegSection;
