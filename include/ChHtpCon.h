...
class CH_EXPORT_CLASS ChHTTPSocketConn : public ChHTTPConn
{
	...
	public:
		...
		virtual void    GetUserAgent( string& strAgent )		{ strAgent =  m_strUserAgent; }
		virtual void    SetUserAgent( const string& strAgent )	{ m_strUserAgent = strAgent; }
		...
		virtual void GetProgressMsg( string& strMsg, int& iPercentComplete ); 
	...
	public:
		static void     UpdateHTTPPreferences( const string& strCompany );
		...
		static const string&  GetHTTPProxy()	{ return m_strHTTPProxy; }
		static const string&  GetFTPProxy()		{ return m_strFTPProxy; }
