...
// $Header: /home/cvs/chaco/include/ChUrlMap.h,v 2.5 1996/02/20 01:34:04 pritham Exp $
...
class CH_EXPORT_CLASS ChURLParts
{
	public :
		...
		bool GetURLParts( const string& strURL, const char* pstrDefURL = 0 );
		...
		// methods
		static bool MapHostFileToURL( const char* pstrLocal, string& strURL );
		static bool MapURLToHostFile( const char* pstrURL, string& strHostFile );
		static void EscapeSpecialChars( string& strData );
