...
typedef ChList<string>	ChArgArray; 
...
class CH_EXPORT_CLASS ChArgumentList
{
	public :
		...
		bool GetArg( int iIndex, string& strName, string& strValue ) const;
		bool FindArg( const char* pstrName, string& strValue );

		void AddArg( const string& strName, 	const string&  strValue );
		void Empty();
	private :
