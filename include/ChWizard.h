...
// $Header: /home/cvs/chaco/include/ChWizard.h,v 2.10 1996/03/22 10:30:49 pritham Exp $
...
class CH_EXPORT_CLASS ChWizardPage : public CDialog
{
	...
	public:
		...
		inline const string& GetCaption() { return m_strCaption; }
	...
	protected:
		...
		void UpdateNameValue( string& strBuffer, const string& strName, const string& strValue );
