...
// $Header: /home/cvs/chaco/include/ChClInfo.h,v 2.5 1996/03/25 21:01:31 pritham Exp $
...
typedef enum { osUnknown = 0, osWin16, osWin32s, osWinNT, osWin95, osLinux,
				osSPARCSolaris } OSType;
...
class CH_EXPORT_CLASS ChClientInfo : public ChStreamable
{
	...
	public:
		...
		inline const string& GetPlatformName() const { return m_strPlatform; }
		inline const ChVersion& GetPlatformVersion() const
							{ return m_platformVersion; }
		inline const string& GetProcessor() const { return m_strProcessor; }
		...
		inline const string& GetSocketsDescription() const
