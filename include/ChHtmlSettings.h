...
class CH_EXPORT_CLASS ChHtmlSettings
{
	public :
		...
		void SetProductName( const string& strProduct );
	...
	// Accessor methods
		...
		inline const string& 	GetFixedFontName()			{ return m_strFixedFontName; }
		inline const string& 	GetProportionalFontName()	{ return m_strProportionalFontName; }
		inline const string& 	GetSymbolFontName()			{ return m_strSymbolFontName; }
	...
	private :
		...
		int				m_iTopIndent;
		int				m_iLeftIndent;
		string  		m_strFixedFontName;
		string  		m_strProportionalFontName;
		string			m_strSymbolFontName;
