...
// $Header: /home/cvs/chaco/include/ChTxtWnd.h,v 2.47 1996/07/05 18:18:11 pritham Exp $
...
#endif
{
	...
	public:
		...
		inline bool GetAppend() { return m_luDocAttrs & docViewAppend; }
	...
	public:
		void ClearPage();
		inline bool AppendText( const string& strNewText,
								chint32 lNewCount = -1,
...
protected:
	...
	bool		AlwaysDisplayAppend()	{ return (m_luDocAttrs & docViewAppend); }
	...
	fstream* GetLogFile()			{ return m_plogStream; }
		...
		void SetTextColor( chuint32 luColor)
				{
					...
					m_luTextClr = (CH_DEF_COLOR & luColor) ?
									::GetSysColor( COLOR_WINDOWTEXT) : luColor;
					#else
					m_luTextClr = luColor;
					// We'll take care of the CH_DEF_COLOR stuff in
					// ChDC instead.
