...
// $Header: /home/cvs/chaco/include/ChSplit.h,v 2.26 1996/09/26 02:03:52 pritham Exp $
...
#endif	// defined( CH_MSW )
{
	...
	public:
		...
		ChSplitterBanner* CreateBanner( ChPane* pPane, const string& strName,
										bool boolTop, bool boolFrame,
										chint16 sClientWidth,
										chint16 sClientHeight );
		void DestroyBanner( ChWnd* pDestructoBanner );
		ChSplitterBanner* FindBanner( const string& strName );
