...
// $Header: /home/cvs/chaco/include/ChSock.h,v 2.13 1996/05/13 22:24:28 pritham Exp $
...
class CH_EXPORT_CLASS ChChacoSocket
{
	public:
		...
		static void GetErrorMsg( int iError, string& strOutput );
	...
	public:
		...
		bool Accept( SOCKADDR *lpAddr = 0, int *lpLen = 0 )
				{
					if (GetSyncSocket())
					{
		...
		bool IOCtl( long lCommand, DWORD* lpArgument )
		      	{
					...
					{
						return GetAsyncSocket()->IOCtl( lCommand, lpArgument );
					}
				}
		...
		bool Listen( int nConnectionBacklog = 5 )
		      	{
					...
					{
						return GetAsyncSocket()->Listen( nConnectionBacklog );
					}
				}
		...
		bool ShutDown( int nHow = sends )
		       	{
					...
					{
						return GetAsyncSocket()->ShutDown( nHow );
					}
				}
	...
	public :
		...
		static void UpdateSocketPreferences( const string& strProduct );
		static bool PumpMessages( HANDLE hWaitOn );

		static HWND GetWSAWnd() { return m_hwndWSA; }

		static const string&  GetSOCKSHost() { return m_strSocksHostName; }
	...
	public:
		...
		static string 		m_strSocksHostName;
